...
static pbar_Data[MAX_PLAYERS][MAX_PLAYER_BARS][E_BAR_DATA], pbar_TextDraw[MAX_PLAYERS][MAX_PLAYER_BARS][E_BAR_TEXT_DRAW];
...
stock PlayerBar:CreatePlayerProgressBar(playerid, Float:x, Float:y, Float:width = 55.5, Float:height = 3.2, colour = 0xFF1C1CFF, Float:max = 100.0, direction = BAR_DIRECTION_RIGHT) {
    if (!IsPlayerConnected(playerid)) {
        // err("attempt to create player progress bar for invalid player",
    ...
    if (barid == INVALID_ITERATOR_SLOT) {
