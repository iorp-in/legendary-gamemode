...
hook OnGameModeInit() {
    ...
    format(string, sizeof string, "");
    strcat(string, "{db6600}---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n");
    strcat(string, "{db6600}/aplayer: {FFFFEE}open player administration panel.\n");
    strcat(string, "{db6600}/acp: {FFFFEE}open admin control panel.\n");
    strcat(string, "{db6600}/ascp: {FFFFEE}open advanced staff control panel.\n");
    strcat(string, "{db6600}---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n");
    Doc:Add(0, Doc:GetFreeID(), "Admin Commands", string, 10);
    return 1;
}
